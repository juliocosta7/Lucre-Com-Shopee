        ...
        return {
            ...
            loadPixel: function() {
                ...
                ids.forEach(function(trackingId, index) {
                    ...
                    config_for_tag.debug_mode = !1;
                    config_for_tag.send_page_view = !options.ga.custom_page_view_event;
                    for (var key in obj) {
                        if (obj.hasOwnProperty(key) && obj[key] === searchValue) {
                            config_for_tag.debug_mode = !0;
                            break
                        }
                    }
                    ...
                    if (isv4(trackingId)) {
                        if (options.ga.disableAdvertisingFeatures) {
                            config_for_tag.allow_google_signals = !1
                        }
                        if (options.ga.disableAdvertisingPersonalization) {
                            config_for_tag.allow_ad_personalization_signals = !1
                        }
                    }
                    ...
                    if (options.ga.hasOwnProperty('serverContainerUrls')) {
                        if (options.ga.serverContainerUrls.hasOwnProperty(trackingId) && options.ga.serverContainerUrls[trackingId].enable_server_container != !1) {
...
function getRootDomain(useSubdomain = !1) {
